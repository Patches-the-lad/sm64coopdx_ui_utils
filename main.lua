...
function M.init()
	...
	-- Yellow panel
	test_panel_2 = M.ui_utils.create_panel({panel_color = {r = 255, g = 255, b = 0, a = 160}, fill_mode = "w_fill", min_w = 200, min_h = 350, padding_x = 10, padding_y = 10})

	-- Blue panel, red border
	test_panel_3 = M.ui_utils.create_panel({panel_color = {r  = 0, g = 0, b = 255, a = 160}, fill_mode = "no_fill", min_w = 200, min_h = 200, anchor_x = .5, anchor_y = .5, border_color = {r = 255, g = 0, b = 0, a = 255}, border_thickness = 10})

	-- Magenta panel
	test_panel_4 = M.ui_utils.create_panel({panel_color = {r  = 255, g = 0, b = 255, a = 160}, fill_mode = "w_fill", min_w = 100, min_h = 100, anchor_x = .5, anchor_y = 1})
