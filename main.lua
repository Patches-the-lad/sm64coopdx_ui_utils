...
function M.init()
	...
	screen = M.ui_utils.create_screen({padding_x = 10, padding_y = 10})

	test_v = M.ui_utils.create_v_stack({fill_mode = "h_fill", padding_x = 0, padding_y = 0, min_w = 800, min_h = 500, spacing_y = 10})
	...
	-- Blue textbox
	test_panel_1 = M.ui_utils.create_textbox({
...
-- 		text = test_text,
	...
	-- Yellow panel
	test_panel_2 = M.ui_utils.create_panel({panel_color = {r = 255, g = 255, b = 0, a = 160}, fill_mode = "fill", min_w = 400, min_h = 300, padding_x = 10, padding_y = 10})

	-- Blue panel, red border
	test_panel_3 = M.ui_utils.create_panel({panel_color = {r  = 0, g = 0, b = 255, a = 160}, fill_mode = "w_fill", min_w = 100, min_h = 100, anchor_x = .5, anchor_y = .5, border_color = {r = 255, g = 0, b = 0, a = 255}, border_thickness = 10})

	-- Magenta panel
	test_panel_4 = M.ui_utils.create_panel({panel_color = {r  = 255, g = 0, b = 255, a = 160}, fill_mode = "fill", min_w = 200, min_h = 100, anchor_x = .5, anchor_y = .5, })

	-- Blue textbox, black border
	test_panel_5 = M.ui_utils.create_textbox({
	...
	-- Green panel
	test_panel_6 = M.ui_utils.create_panel({panel_color = {r  = 0, g = 255, b = 0, a = 160}, fill_mode = "h_fill", min_w = 100, min_h = 100, draw_border = false})
...
function M.update()
	...
	test_grid.arg_params.min_w = (math.sin(test_var_2) + 1) / 2 * 800 + 800
	test_grid.arg_params.min_h = (math.cos(test_var_2) + 1) / 2 * 500 + 500
end
